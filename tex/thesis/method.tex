...
\begin{figure}[h]
    \begin{center}
        \includegraphics[width=0.5\textwidth]{../figures/'XOR problem' dataset.png}
    \end{center}
...
\begin{figure}[h]
    \begin{center}
        \includegraphics[width=0.5\textwidth]{../figures/'Iris' dataset - with PCA applied.png}
    \end{center}
...
\begin{figure}[h]
    \begin{center}
        \includegraphics[width=0.5\textwidth]{../figures/'Breast Cancer' dataset - with PCA applied.png}
    \end{center}
...
\begin{figure}[h]
    \begin{center}
        \includegraphics[width=0.5\textwidth]{../figures/'Digits' dataset - with PCA applied.png}
    \end{center}
...
\begin{figure}[h]
    ...
    \begin{subfigure}[t]{0.32\textwidth}
        \centering
        \includegraphics[width=0.95\textwidth]{../figures/'Synthetic, 2500 features' dataset - with PCA applied.png}
...
\begin{figure}[h]
    ...
    \begin{subfigure}[t]{0.32\textwidth}
        \centering
        \includegraphics[width=0.95\textwidth]{../figures/'SMS Spam, 500 features' dataset - with PCA applied.png}
