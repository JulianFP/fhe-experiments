...
Because of this we expect the standard deviation (plotted as error bars in our plots) to be much lower on the PC runs.
...
In this case however the recommended usage of \ac{pca} probably crippled the model quite a bit to the point were using it over Logistic Regression makes no sense considering it's increased runtimes.
