...
In \cref{fig:cluster_acc_f1} we can see an overview of the accuracy and F1-Scores of our three models.
...
\end{figure}\label{fig:cluster_acc_f1}
...
See \cref{fig:cluster_runtime_logReg}, \cref{fig:cluster_runtime_xgb}, \cref{fig:cluster_runtime_neural_net}.
...
Since we executed our synthetic dataset with a variety of feature size, we can look at how runtimes grow with the dimensionality of the input features (see \cref{fig:cluster_feature-runtime}).
...
\begin{figure}[h]
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        ...
        \caption{Neural Network}
    \end{subfigure}
    \caption{Runtimes plotted against feature size of the 'Synthetic' dataset of all of our three models in both clear and FHE, plotted on a logarithmic scale, drawn from the cluster run of the experiments}\label{fig:cluster_feature-runtime}
\end{figure}
